...
enum BTStatus { SUCCEEDED = 0, FAILED = 1, CANCELED = 2 };

enum NodeCheckType { CHECK_TO_START = 1, CHECK_TO_PAUSE = 2, CHECK_TO_CLEANUP = 3 };
...
enum GaitChangePriority { LOCK_DETECT = 255, MODE_TRIG = 254, GAIT_TRIG = 253, ORDER_REQ = 252 };
